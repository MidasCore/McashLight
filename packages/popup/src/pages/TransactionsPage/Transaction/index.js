...
import { SUPPORTED_CONTRACTS } from '@mcashlight/lib/constants';
...
const renderAmount = (type, transaction, direction) => {
    ...
    switch(type) {
        case 'FreezeBalanceContract':
            amount = transaction.raw.value.frozen_balance / 100000000;
            direction = 'from';
            break;
...
const transformAddress = address => {
    const transformedAddress = McashWeb.address.fromHex(address);
