                    ...
                    <Accordion className='my-accordion' onChange={this.onChange}>
                        ...
                        <Accordion.Panel header={formatMessage({ id: 'BANK.HELP.CONTACT' })}π className='feedback'>
                            <section className='feedbackCont'>
                                ...
                                <p className='content'>
                                    <img src={require('../../assets/images/new/tronBank/telegram.svg')} alt='telegram'/><a href='https://t.me/McashLight' rel='noopener noreferrer' target='_blank'><span className='linkStyle'>（McashLight Official Group）</span></a>
                                </p>
                                <h2 className='title'>
                                    <FormattedMessage id='BANK.HELP.FEEDBACK' />
                                </h2>
                                <p className='content single'>
                                    tronlending@mcashlight.org
                                </p>
                            </section>
                        </Accordion.Panel>
                    </Accordion>
